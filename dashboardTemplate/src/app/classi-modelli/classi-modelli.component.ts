...
@Component({
  selector: 'app-classi-modelli',
  templateUrl: './classi-modelli.component.html',
  styleUrls: ['./classi-modelli.component.css']
})
export class ClassiModelliComponent implements OnInit {
  editField: String;
  ...
  initSim() {
    ...
    const table = $('#simDatatable1').DataTable({
      data: this.data,
      'columnDefs': [{
        'targets': -1,
        'data': null,
